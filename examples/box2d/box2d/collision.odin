...
foreign lib {
	...
	DynamicTree_Query :: proc(tree: ^DynamicTree, aabb: AABB, maskBits: u64, callback: ^proc "c" (i32, i32, rawptr) -> bool, _context: rawptr) -> TreeStats ---
	...
	///	@return performance data
	DynamicTree_RayCast :: proc(tree: ^DynamicTree, input: ^RayCastInput, maskBits: u64, callback: ^proc "c" (^RayCastInput, i32, i32, rawptr) -> f32, _context: rawptr) -> TreeStats ---
	...
	/// @param context user context that is passed to the callback
	///	@return performance data
	DynamicTree_ShapeCast :: proc(tree: ^DynamicTree, input: ^ShapeCastInput, maskBits: u64, callback: ^proc "c" (^ShapeCastInput, i32, i32, rawptr) -> f32, _context: rawptr) -> TreeStats ---

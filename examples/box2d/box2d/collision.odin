...
foreign lib {
	...
	DynamicTree_CreateProxy :: proc(tree: ^DynamicTree, aabb: AABB, categoryBits: uint64_t, userData: i32) -> i32 ---
	...
	DynamicTree_Query :: proc(tree: ^DynamicTree, aabb: AABB, maskBits: uint64_t, callback: ^TreeQueryCallbackFcn, _context: rawptr) -> TreeStats ---
	...
	///	@return performance data
	DynamicTree_RayCast :: proc(tree: ^DynamicTree, input: ^RayCastInput, maskBits: uint64_t, callback: ^TreeRayCastCallbackFcn, _context: rawptr) -> TreeStats ---
	...
	/// @param context user context that is passed to the callback
	///	@return performance data
	DynamicTree_ShapeCast :: proc(tree: ^DynamicTree, input: ^ShapeCastInput, maskBits: uint64_t, callback: ^TreeShapeCastCallbackFcn, _context: rawptr) -> TreeStats ---
